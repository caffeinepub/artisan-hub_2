    ...
    <footer className="border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="font-serif text-lg font-semibold mb-3">
              Original Creations Hub
            </h3>
            <p className="text-sm text-muted-foreground">
              Discover unique, custom-made creations crafted with passion and
              attention to detail.
            </p>
          </div>
          ...
          <div>
            ...
            {shopDetails?.contactDetails?.email && (
              <p className="text-sm text-muted-foreground">
                Email:{" "}
                <a
                  href={`mailto:${shopDetails.contactDetails.email}`}
        ...
        <div className="mt-8 pt-6 border-t text-center text-sm text-muted-foreground">
          <p>
            © {new Date().getFullYear()} Original Creations Hub. All rights
            reserved.
          </p>
