...
import { Music, Play, ShoppingBag, Loader2, Music2, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    <article className="flex-none w-72 bg-card border border-border rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-1 gap-3">
        ...
        <div className="flex items-center justify-between mt-auto pt-1">
          <span className="font-semibold text-primary text-base">A${priceAUD}</span>
        </div>
    ...
    return (
      <div className="flex gap-4 overflow-hidden py-2">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="flex-none w-72 bg-card border border-border rounded-2xl overflow-hidden">
    ...
    <div className="relative">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-serif text-xl font-bold text-foreground">Try Before You Buy</h2>
